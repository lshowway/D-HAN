...
def get_args():
    ...
    # addressa
    parser.add_argument('--train_root', type=str, default='../addressa/userSeq_train')
    parser.add_argument('--test_root', type=str, default='../addressa/userSeq_test')
    parser.add_argument('--content_word', type=str, default='../addressa/news_id_content_split')
    parser.add_argument('--content_word_w', type=str, default='../addressa/news_id_content_split.vec')
    parser.add_argument('--element_root', type=str, default='../addressa/newsid_Entity_embed')
    parser.add_argument('--element_root_w', type=str, default='../addressa/newsid_Entity_embed.vec')
    parser.add_argument('--generate_seq', type=str, default='../addressa/generateSequence/')
    parser.add_argument('--doc2vec_model', type=str, default='../addressa/doc2vec_addressa')
    parser.add_argument('--candidate_root', type=str, default='../addressa/user_candidate')
    ## addressa
...
if __name__ == '__main__':
    ...
    model = Recommender(n_iter=config.n_iter, neg_samples=config.neg_samples,
